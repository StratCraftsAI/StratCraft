/**
 * useProviderList -- unified provider status hook (host copy)
 *
 ...
 *   - Host: apps/desktop/src/renderer/hooks/useProviderList.ts (this file)
 *   - quant-lab: plugins/quant-lab-nexus/ui/quant-lab-nexus/src/hooks/useProviderList.ts
 *   - back-test: plugins/back-test-nexus/ui/src/hooks/useProviderList.ts
 */
